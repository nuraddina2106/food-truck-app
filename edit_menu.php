...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Handle image upload
    $menu_image = $menu['menu_image']; // Retain existing image by default
    ...
    if (empty($menu_name) || empty($menu_desc) || empty($menu_price) || empty($truck_id)) {
        ...
        $stmt->bind_param("sssiii", $menu_name, $menu_desc, $menu_price, $menu_image, $truck_id, $menu_id);
        ...
        <div class="form-container">
            ...
            <form method="post" action="" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <input type="text" id="menu_desc" name="menu_desc" value="<?php echo htmlspecialchars($menu['menu_desc']); ?>" required>
                </div>

                <div class="form-row">
                    <label for="menu_price">Price</label>
                    <input type="number" id="menu_price" name="menu_price" value="<?php echo htmlspecialchars($menu['menu_price']); ?>" step="0.01" required>
                </div>
